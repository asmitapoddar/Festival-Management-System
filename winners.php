...
<nav class="navbar navbar-default" role="navigation">
	...
	<div class="container">
	<h2 style="color:firebrick;">Winners</h2>
	...
	<thead style="padding-top:50px; padding-bottom:55px;">
        <tr>
          ...
          <th style="padding-left:100px; padding-top:25px;"><center>Score</center></th>
	...
	<?php 
     ...
     echo '<td style="padding-left:100px; padding-top:25px;"><center>' . $row['Score'] . '</center></td>';
      echo '<td style="padding-left:100px; padding-top:25px;"><center>' . $row['School'] . '</center></td>';
     echo '</tr>';
	 }
	 ?>
	 </tbody>
